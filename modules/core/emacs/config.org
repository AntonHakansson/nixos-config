...
#+begin_src emacs-lisp
(package! org-evil-navigation :recipe (:repo "mskorzhinskiy/org-evil-navigation" :host github))
#+end_src
...
(setq org-directory "~/org" org-log-done 'time ; insert timestamp when an item
...
(map! :map org-mode-map :leader (:prefix-map ("=" . "calc") "=" #'calc-dispatch
      "c" #'calc "q" #'quick-calc "g" #'calc-grab-region))
#+end_src
*** Functionality
**** Spellcheck
